...
{
    /// <summary>
    /// Provides logic to extract base names from resource names, removing a specified assembly prefix and the 
    /// standard <c>.resources</c> extension.
    /// </summary>
    /// <remarks>
    /// This implementation uses<see cref = "string.Substring(int, int)" /> for compatibility with frameworks 
    /// prior to.NET 8, and is functionally equivalent to the range-based extractor defined for .NET 8 and higher.
    /// </remarks>
    /// <seealso cref="IResourceBaseNameExtractor"/>
    internal class SubstringBasedBaseNameExtractor : IResourceBaseNameExtractor
    {
        /// <summary>
        /// Extracts base names from the specified resource names, removing the standard <c>.resources</c> extension 
        /// and stripping the provided assembly prefix if present.
        /// </summary>
        /// <param name="assemblyPrefix">
        /// The assembly prefix to remove from the beginning of resource names (e.g., the default namespace of the 
        /// assembly). If the base name starts with this prefix, it will be removed along with any subsequent dot 
        /// separator.
        /// </param>
